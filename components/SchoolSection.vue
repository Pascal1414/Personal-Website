    ...
    <div class="scroll-hidden py-8  mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
      <div class="flex flex-col justify-center">
        <h1 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">
          School</h1>
        <p class="mb-6 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">While I am working a go to school
        </p>
      ...
      <div class="flex flex-col overflow-hidden  gap-5">
        ...
        <div class="lg:max-w-xl p-6  sm:p-8 bg-white rounded-lg shadow-xl dark:bg-gray-800">
          ...
          <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">Technische Berufsschule Zürich (TBZ) is a
