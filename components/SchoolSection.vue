  ...
  window.addEventListener('scroll', () => {
    ...
    if (schoolContentRef.value) {
      schoolContentRef.value.style.marginTop = `${
        getScrollProgress(schoolContentRef.value) / parallaxSpeedDivisor - props.minusMarginTop
      }px`
    }
...
function setSectionHeightToContentHeight() {
  ...
  sectionHeight.value = `${
    getMaxScrollProgress(schoolContentRef.value) +
    schoolContentRef.value.clientHeight -
    props.minusMarginTop
  }px`
}
...
#school-content {
  ...
  --mask: radial-gradient(91.68px at 50% 123px, #000 99%, #0000 101%) calc(50% - 82px) 0/164px 51%
      repeat-x,
    radial-gradient(91.68px at 50% -82px, #0000 99%, #000 101%) 50% 41px/164px calc(51% - 41px)
      repeat-x,
    radial-gradient(91.68px at 50% calc(100% - 123px), #000 99%, #0000 101%) calc(50% - 82px) 100%/164px
      51% repeat-x,
    radial-gradient(91.68px at 50% calc(100% + 82px), #0000 99%, #000 101%) 50% calc(100% - 41px) /
      164px calc(51% - 41px) repeat-x;
